...
# Query 7: 
# What are the top 5 account_ids with the lowest loan
...
# Note: There shouldn't be a table name order, since order is reserved from the ORDER BY 
# clause. You have to use backticks to escape the order table name.
...
# Query 11:
# In the order table, what are the individual amounts that were sent 
...
# Query 15
# Using the loan table, print the top 10 account_ids based on the sum of 
# all of their loan amounts.
